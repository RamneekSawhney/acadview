...
class Test
{
    ...
    void print(int a)
    {
        System.out.print("When an Int arguments is passed in print,this function is called.");
    }
    void print(float b)
    {
        System.out.print("When a Float arguments is passed in print,this function is called.");
    }
}
class Func_Overload
{
